...
# storcli.rb — Facter structured fact for MegaRAID / Dell PERC controllers
#
...
#
# Design notes:
#  - Dell systems use perccli; all others use storcli.
...
Facter.add(:storcli) do
  ...
  setcode do
    ...
    Facter.warn("storcli: fact collection timed out after #{Megaraid::STORCLI_TIMEOUT} seconds")
